...
public class _01날짜와시간 {
	public static void main(String[] args) {
		...
		LocalDate tomorrow=today.plusDays(100); //100일 더하기
		System.out.println(tomorrow);
		
		LocalDate tempDate=today.minusYears(10); //100일 빼기
		System.out.println(tempDate);
		
		//두 날짜 사이의 간격
		LocalDate test1=LocalDate.of(2030, 5, 5);
		Period test2= Period.between(test1, today);
		System.out.printf("%d년 %d월 %d일", test2.getYears(), test2.getMonths(), test2.getDays());
		
		Duration test3=Duration.between(LocalDateTime.of(2025, 01,22,13,12), LocalDateTime.of(2025, 01,22,13,55));
